...
def main():
    ...
    table_cards.append([6, "Diamond"])
    table_cards.append([6, "Spade"])
    table_cards.append([7, "Clove"])
    table_cards.append(["Ace", "Heart"])
    table_cards.append(["Ace", "Diamond"])
    player = {}
    player[1]=[]
    player[1].append([6, "Diamond"])
    player[1].append([9, "Heart"])
    player[2]=[]
    player[2].append([6, "Spade"])
    player[2].append([7, "Heart"])
    player[3]=[]
    player[3].append([6, "Clove"])
    player[3].append(["Ace", "Diamond"])
    player[4]=[]
    player[4].append([6, "Clove"])
    player[4].append(["Ace", "Diamond"])
    players_points = []
    ...
    for i in range(1, num_player+1):
        ...
        if flush_indicator1[0]==True and straight_indicator1[0] == True and straight_indicator1[1] == 14:
            players_points.append(10)
        elif flush_indicator1[0]==True and straight_indicator1[0] == True:
            length= 5
            for i in range(len(flush_indicator1[1])):
                if flush_indicator1[1][i] == straight_indicator1[1]-length:
                    length = length-1
            if length == 0:
    ...
    if len(indexOfScores) ==1:
        ...
        ties_wins.fullhouse_ties(players_points, player, table_cards, indexOfScores)
